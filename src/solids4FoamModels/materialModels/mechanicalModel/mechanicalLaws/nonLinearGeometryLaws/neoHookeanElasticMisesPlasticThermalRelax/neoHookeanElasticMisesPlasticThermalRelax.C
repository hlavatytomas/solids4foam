...
#include "neoHookeanElasticMisesPlasticThermalRelax.H"
...
namespace Foam
{
    defineTypeNameAndDebug(neoHookeanElasticMisesPlasticThermalRelax, 0);
    addToRunTimeSelectionTable
    (
        mechanicalLaw, neoHookeanElasticMisesPlasticThermalRelax, nonLinGeomMechLaw
    );

// * * * * * * * * * * * * * * Static Members  * * * * * * * * * * * * * * * //

    // Tolerance for Newton loop
    scalar neoHookeanElasticMisesPlasticThermalRelax::LoopTol_ = 1e-8;

    // Maximum number of iterations for Newton loop
    label neoHookeanElasticMisesPlasticThermalRelax::MaxNewtonIter_ = 200;

    // finiteDiff is the delta for finite difference differentiation
    scalar neoHookeanElasticMisesPlasticThermalRelax::finiteDiff_ = 0.25e-6;

    // Store sqrt(2/3) as we use it often
    scalar neoHookeanElasticMisesPlasticThermalRelax::sqrtTwoOverThree_ = ::sqrt(2.0/3.0);
...
void Foam::neoHookeanElasticMisesPlasticThermalRelax::makeJ()
{
    if (JPtr_.valid())
    {
        FatalErrorIn("void Foam::neoHookeanElasticMisesPlasticThermalRelax::makeJ()")
...
Foam::volScalarField& Foam::neoHookeanElasticMisesPlasticThermalRelax::J()
{
    if (JPtr_.empty())
    {
        makeJ();
...
void Foam::neoHookeanElasticMisesPlasticThermalRelax::makeJf()
{
    if (JfPtr_.valid())
    {
        FatalErrorIn("void Foam::neoHookeanElasticMisesPlasticThermalRelax::makeJf()")
            << "pointer already set" << abort(FatalError);
    }
...
Foam::surfaceScalarField& Foam::neoHookeanElasticMisesPlasticThermalRelax::Jf()
{
    if (JfPtr_.empty())
    {
        makeJf();
...
Foam::scalar Foam::neoHookeanElasticMisesPlasticThermalRelax::curYieldStress
(
...
Foam::scalar Foam::neoHookeanElasticMisesPlasticThermalRelax::yieldFunction
(
...
void Foam::neoHookeanElasticMisesPlasticThermalRelax::newtonLoop
(
...
) const
{
    ...
    do
    {
        ...
        if (i == MaxNewtonIter_)
        {
            WarningIn("neoHookeanElasticMisesPlasticThermalRelax::newtonLoop()")
...
Foam::tmp<Foam::volScalarField> Foam::neoHookeanElasticMisesPlasticThermalRelax::Ibar
(
...
Foam::tmp<Foam::surfaceScalarField> Foam::neoHookeanElasticMisesPlasticThermalRelax::Ibar
(
...
Foam::neoHookeanElasticMisesPlasticThermalRelax::neoHookeanElasticMisesPlasticThermalRelax
(
    const word& name,
    const fvMesh& mesh,
    ...
    )
{
    ...
    else
    {
        FatalErrorIn
        (
            "neoHookeanElasticMisesPlasticThermalRelax::neoHookeanElasticMisesPlasticThermalRelax::()"
...
Foam::neoHookeanElasticMisesPlasticThermalRelax::impK() const
{
...
void Foam::neoHookeanElasticMisesPlasticThermalRelax::correct(volSymmTensorField& sigma)
{
...
void Foam::neoHookeanElasticMisesPlasticThermalRelax::correct(surfaceSymmTensorField& sigma)
{
    // Update the deformation gradient field
    // Note: if true is returned, it means that linearised elasticity was
    // enforced by the solver via the enforceLinear switch
...
Foam::scalar Foam::neoHookeanElasticMisesPlasticThermalRelax::residual()
{
...
void Foam::neoHookeanElasticMisesPlasticThermalRelax::updateTotalFields()
{
...
Foam::scalar Foam::neoHookeanElasticMisesPlasticThermalRelax::newDeltaT()
{
...
void Foam::neoHookeanElasticMisesPlasticThermalRelax::setRestart()
{
